...
func main() {
	...
	defer conn.Close() // No final da execução dessa função main, a conexão com o bd é fechada
	...
	streamChannel := make(chan chatcompletionstream.ChatCompletionOutputDTO) // pq output??
